...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    " Syntax Elements
    call <SID>X("String", "4306ff", "", "")
    call <SID>X("Constant", "4306ff", "", "")
    call <SID>X("Number", "4306ff", "", "")
    call <SID>X("Statement", "4306ff", "", "")
    call <SID>X("Function", "4306ff", "", "")
    call <SID>X("PreProc", "4306ff", "", "")
    call <SID>X("Comment", "4306ff", "", "bold")
    call <SID>X("Type", "4306ff", "", "")
    call <SID>X("Error", "ffffff", "4306ff", "")
    call <SID>X("Identifier", "4306ff", "", "")
    call <SID>X("Label", "4306ff", "", "")
